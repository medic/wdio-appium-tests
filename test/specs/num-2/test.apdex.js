...
const instanceUrl = process.env.NE_URL;
const username = process.env.NE_USERNAME;
const password = process.env.NE_PASSWORD;
...
describe('Apdex Performance Workflows', () => {
    ...
    it('should open the tasks page and view a task', async () => {
        await TasksPage.viewATaskNE();
    })

    it('should open the reports page and view a report', async () => {
        await ReportsPage.viewAReportNE();
    })
